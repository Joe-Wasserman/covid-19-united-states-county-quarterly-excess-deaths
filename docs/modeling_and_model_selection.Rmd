...
knitr::opts_chunk$set(
  ...
  fig.path = "modeling_and_model_selection_files/"
)
...
By these metrics, model 5 (counties nested within county sets nested within census divisions) appears to perform the best.
